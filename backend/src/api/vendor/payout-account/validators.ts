...
>
export const VendorGetPayoutAccountParams: any = createSelectParams()
 ...
 *     nullable: true
 */
export const VendorCreatePayoutAccount = z.object({
 ...
 *     nullable: true
 */
export const VendorCreateOnboarding = z.object({
  context: z.record(z.unknown()).optional()
})
