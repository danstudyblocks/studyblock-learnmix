...
/**
 * S3 URL for the storage bucket
 */
export const S3_URL = assertValue(
  process.env.S3_URL,
  'Environment variable for S3_URL is not set'
)

/**
 * S3 Bucket Name
 */
export const S3_BUCKET = assertValue(
  process.env.S3_BUCKET,
  'Environment variable for S3_BUCKET is not set'
)

/**
 * S3 Region
 */
export const S3_REGION = assertValue(
  process.env.S3_REGION,
  'Environment variable for S3_REGION is not set'
)

/**
 * S3 Access Key ID
 */
export const S3_ACCESS_KEY_ID = assertValue(
  process.env.S3_ACCESS_KEY_ID,
  'Environment variable for S3_ACCESS_KEY_ID is not set'
)

/**
 * S3 Secret Access Key
 */
export const S3_SECRET_ACCESS_KEY = assertValue(
  process.env.S3_SECRET_ACCESS_KEY,
  'Environment variable for S3_SECRET_ACCESS_KEY is not set'
)

/**
 * S3 Cache Control
 */
export const S3_CACHE_CONTROL = process.env.S3_CACHE_CONTROL ?? 'max-age=31536000, public'

/**
 * S3 Access Type
 */
export const S3_ACCESS = process.env.S3_ACCESS || 'public'
