...
export class Migration20251119172219 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`create table if not exists "digital_product" ("id" text not null, "name" text not null, "creator_id" text null, "is_premium" boolean not null default false, "show_in_studio" boolean not null default false, "category_top" text null, "category_sub" text null, "tags" text[] null, "thumbnail" text null, "isTemplate" boolean not null default false, "template_data" jsonb null, "approval_status" text not null default 'pending', "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "digital_product_pkey" primary key ("id"));`);
