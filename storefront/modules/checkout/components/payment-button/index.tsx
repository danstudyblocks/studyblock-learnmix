...
const PaymentButton: React.FC<PaymentButtonProps> = ({
  ...
  // For digital products, we don't need shipping address, billing address, or shipping methods
  // For physical products, we need all of them
  const notReady = isDigital
    ? !cart || !cart.email
    : !cart ||
...
const StripePaymentButton = ({
  ...
  const handlePayment = async () => {
    ...
    // For digital products, we may not have billing address, so use minimal billing details
    const billingDetails = isDigital
      ? {
          email: cart.email,
        }
      : {
