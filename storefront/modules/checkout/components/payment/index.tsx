...
const Payment = ({
  ...
  // For digital products, payment is ready if we have an active session or paid by giftcard
  // For physical products, we also need shipping methods
  const paymentReady =
    (activeSession && (isDigital || cart?.shipping_methods.length !== 0)) || paidByGiftcard
          ...
          {!paidByGiftcard && availablePaymentMethods?.length && (
            <>
              ...
              {isStripe && stripeReady && (
                <div className="mt-5 mb-5 transition-all duration-150 ease-in-out">
