...
export default async function StorePage({ searchParams, params }: Params) {
  ...
  return (
    <>
      <section className="sbp-30 stp-30 mt-[100px] pt-6">
      <h2 className="container heading-2 font-[800] text-n600 max-sm:pr-10">
        Find the <span className="text-sbhtext">right</span> resource <br /> for
        every classroom
      </h2>
