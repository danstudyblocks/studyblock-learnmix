...
import discoverImg from "@/public/svg/discover-img.svg"
...
const heroCards = [
  {
    ...
    description: "Turn your new designs into professionally printed displays, postcards, stickers and exercise books, ready to create an impact in your classroom! Delivered to your classroom within 5 working days.",
    image: discoverImg,
              ...
              <div className="flex flex-col h-full p-6">
                ...
                <div className="flex flex-col lg:flex-row lg:justify-between gap-6 h-full">
                  ...
                  <div className="flex flex-col flex-1">
                    ...
                    <Link href={card.link}>
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="w-full lg:w-fit bg-[#E3E6EB] text-black font-bold py-2.5 px-6 rounded-lg transition-all text-[15px] hover:bg-opacity-90 hover:shadow-md mx-auto lg:mx-0"
                      >
                        {card.buttonText}
                      </motion.button>
                    </Link>
                  ...
                  <Image
                    ...
                    alt="Design and print"
                    // fill
                    className="object-cover hidden lg:block lg:w-[65%] relative h-[300px] lg:h-full"
                  />
                  {/* </motion.div> */}
                </div>
              </div>
