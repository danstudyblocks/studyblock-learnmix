...
function ProductCardsSection3({ products}:any) {
  ...
  const CardSkeleton = ({ type }: { type: "small" }) => (
    <div
      className={`bg-white rounded-lg border-2 border-gray-200 overflow-hidden col-span-12 sm:col-span-6 lg:col-span-3 h-[31em]`}
    >
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6 mb-8 mt-5 container"
      >
        <motion.button
        ...
        >
          New templates <FaRegStar className="text-lg" />
        </motion.button>
...
export default ProductCardsSection3
