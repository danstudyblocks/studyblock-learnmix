...
import { MinimalisticToolbarStyles } from "./MinimalisticToolbarStyles"
...
export const MinimalisticDesignEdit = ({ customer }: any) => {
  useEffect(() => {
...
export default MinimalisticDesignEdit
